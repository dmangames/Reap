...
public class IntroActivity extends AppIntro2 {
    ...
    public void init(@Nullable Bundle savedInstanceState) {
        ...
        addSlide(AppIntroFragment.newInstance("Custom Activities", "Create custom activities specific to your needs with an array of built-in icons", R.drawable.icons, sandColor, Color.BLACK, Color.BLACK));
        ...
        addSlide(AppIntroFragment.newInstance("Breaks", "Easily pause your current activity and change to a break", R.drawable.breaks, sandColor, Color.BLACK, Color.BLACK));
        addSlide(AppIntroFragment.newInstance("Progress", "Track your progress for each activity. Each icon or \"jar\" represents an hour of work", R.drawable.jars, sandColor, Color.BLACK, Color.BLACK));
